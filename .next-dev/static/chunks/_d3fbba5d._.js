...
"[project]/src/components/admin/bans/AppealReviewModal.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const humanize = (s)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$security$2f$sanitization$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sanitizeStrict"])(s).replace(/_/g, ' ').replace(/\b\w/g, (c)=>c.toUpperCase());
function AppealReviewModal(param) {
    let { ban, appealReviewNotes, setAppealReviewNotes, isLoading, onClose, onConfirm, onShowEvidence } = param;
    _s();
    if (!ban) return null;
    ...
    const handleNotesChange = (value)=>{
        setAppealReviewNotes((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$security$2f$sanitization$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sanitizeStrict"])(value));
    };
    const handleKeyDown = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppealReviewModal.useCallback[handleKeyDown]": (e)=>{
            if (e.key === 'Escape' && !isLoading) {
                e.stopPropagation();
                onClose();
            }
        }
    }["AppealReviewModal.useCallback[handleKeyDown]"], [
        isLoading,
        onClose
    ]);
    const handleOverlayClick = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppealReviewModal.useCallback[handleOverlayClick]": (e)=>{
            if (e.currentTarget === e.target && !isLoading) onClose();
        }
    }["AppealReviewModal.useCallback[handleOverlayClick]"], [
        isLoading,
        onClose
    ]);
    // Sanitize fields rendered directly
    const safeUsername = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$security$2f$sanitization$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sanitizeStrict"])(ban.username || '');
    const safeBanType = humanize(ban.banType || '');
    const safeBannedBy = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$security$2f$sanitization$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sanitizeStrict"])(ban.bannedBy || '');
    // Build a guaranteed-string reason for display (avoid getBanReasonDisplay returning elements)
    const rawReason = ban.reason === 'other' ? ban.customReason || 'Unknown Reason' : typeof ban.reason === 'string' ? ban.reason : 'Unknown Reason';
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$message$2d$square$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__MessageSquare$3e$__["MessageSquare"], {
                            ...
                            fileName: "[project]/src/components/admin/bans/AppealReviewModal.tsx",
                            lineNumber: 105,
                            columnNumber: 11
                        }, this),
                        "Review Appeal - ",
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "bg-[#222] border border-gray-700 rounded-lg p-4 mb-4",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h4", {
                            className: "text-lg font-semibold text-white mb-2",
                            children: "Original Ban"
                        }, void 0, false, {
                            fileName: "[project]/src/components/admin/bans/AppealReviewModal.tsx",
                            lineNumber: 111,
                            columnNumber: 11
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "text-gray-300",
                                            children: safeDate(ban.startTime)
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/admin/bans/AppealReviewModal.tsx",
                                            lineNumber: 133,
                                            columnNumber: 15
                        ...
                        ban.notes && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "mt-2",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    className: "text-gray-400",
                                    children: "Original Notes:"
                                }, void 0, false, {
                                    fileName: "[project]/src/components/admin/bans/AppealReviewModal.tsx",
                                    lineNumber: 138,
                                    columnNumber: 15
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "bg-orange-900/10 border border-orange-800 rounded-lg p-4 mb-4",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                "Submitted: ",
                                ban.appealDate ? safeDate(ban.appealDate) : 'Unknown'
                            ]
                        }, void 0, true, {
                            fileName: "[project]/src/components/admin/bans/AppealReviewModal.tsx",
                            lineNumber: 166,
...
_s(AppealReviewModal, "gDPtzi/OI0BhOuqx/aMFMdmu7t4=");
_c = AppealReviewModal;
var _c;
__turbopack_context__.k.register(_c, "AppealReviewModal");
...
//# sourceMappingURL=_d3fbba5d._.js.map