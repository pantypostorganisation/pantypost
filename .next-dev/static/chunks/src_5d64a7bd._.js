...
function getEnvBool(key) {
    let defaultValue = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
...
const buildApiUrl = (endpoint, params)=>{
    ...
    if (!url.startsWith('http')) {
        url = "".concat(apiConfig.baseUrl).concat(url);
    }
    return url;
};
...
"[project]/src/utils/security/sanitization.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function sanitizeHtml(dirty) {
    ...
    if ("TURBOPACK compile-time truthy", 1) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$dompurify$2f$dist$2f$purify$2e$es$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].sanitize(dirty, DOMPURIFY_CONFIG);
    }
...
function sanitizeStrict(dirty) {
    ...
    if ("TURBOPACK compile-time truthy", 1) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$dompurify$2f$dist$2f$purify$2e$es$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].sanitize(dirty, STRICT_CONFIG);
    }
    //TURBOPACK unreachable
    ;
}
...
function sanitizeNumber(input) {
    let min = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, max = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : Number.MAX_SAFE_INTEGER, decimals = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 2;
    let num;
...
function sanitizeStringArray(arr) {
    let maxItems = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 50, itemSanitizer = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : sanitizeStrict;
...
"[project]/src/utils/validation/schemas.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const authSchemas = {
    username: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(3, 'Username must be at least 3 characters').max(30, 'Username must be at most 30 characters').regex(PATTERNS.username, 'Username can only contain letters, numbers, underscores, and hyphens').transform(sanitizers.lowercase).refine((val)=>![
            'admin',
            'root',
            'system',
            'pantypost'
        ].includes(val), 'This username is reserved'),
    email: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'Email is required').email('Invalid email address').transform(sanitizers.lowercase).refine((val)=>!val.includes('+'), 'Email aliases with + are not allowed'),
    ...
    loginSchema: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        username: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'Username is required').transform(sanitizers.lowercase),
    ...
    signupSchema: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        username: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(3, 'Username must be at least 3 characters').max(30, 'Username must be at most 30 characters').regex(PATTERNS.username, 'Username can only contain letters, numbers, underscores, and hyphens').transform(sanitizers.lowercase),
        email: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'Email is required').email('Invalid email address').transform(sanitizers.lowercase),
        ...
        termsAccepted: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].boolean().refine((val)=>val === true, 'You must agree to the terms'),
        ageVerified: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].boolean().refine((val)=>val === true, 'You must confirm you are 18 or older')
...
const profileSchemas = {
    displayName: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(2, 'Display name must be at least 2 characters').max(50, 'Display name must be at most 50 characters').transform(sanitizers.normalizeSpaces).refine((val)=>!/<[^>]*>/.test(val), 'Display name cannot contain HTML'),
    bio: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().max(500, 'Bio must be at most 500 characters').transform(sanitizers.normalizeSpaces).optional(),
    location: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().max(100, 'Location must be at most 100 characters').transform(sanitizers.normalizeSpaces).optional(),
    socialLinks: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        twitter: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().url('Invalid Twitter URL').optional().or(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].literal('')),
        instagram: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().url('Invalid Instagram URL').optional().or(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].literal('')),
        onlyfans: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().url('Invalid OnlyFans URL').optional().or(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].literal(''))
    }).optional(),
    profileUpdateSchema: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        ...
        bio: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().max(500, 'Bio must be at most 500 characters').transform(sanitizers.normalizeSpaces).optional(),
        location: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().max(100, 'Location must be at most 100 characters').transform(sanitizers.normalizeSpaces).optional(),
        avatarUrl: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().url('Invalid avatar URL').optional().or(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].literal(''))
    })
};
const listingSchemas = {
    title: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(5, 'Title must be at least 5 characters').max(100, 'Title must be at most 100 characters').transform(sanitizers.normalizeSpaces).refine((val)=>!/<[^>]*>/.test(val), 'Title cannot contain HTML'),
    description: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(20, 'Description must be at least 20 characters').max(2000, 'Description must be at most 2000 characters').transform(sanitizers.normalizeSpaces).refine((val)=>!/<[^>]*>/.test(val), 'Description cannot contain HTML'),
    price: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().regex(PATTERNS.price, 'Invalid price format').transform((val)=>parseFloat(val)).refine((val)=>val >= 0.01, 'Price must be at least $0.01').refine((val)=>val <= 10000, 'Price cannot exceed $10,000'),
    ...
    condition: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].enum([
        'new',
        'worn_once',
        'well_worn'
    ], {
    ...
    size: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].enum([
        'xs',
        's',
        'm',
        'l',
    ...
    tags: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].array(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().max(30, 'Tag is too long')).max(10, 'Maximum 10 tags allowed').transform((tags)=>tags.map((tag)=>sanitizers.normalizeSpaces(tag))).optional(),
    wearDuration: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().min(0, 'Wear duration cannot be negative').max(30, 'Wear duration cannot exceed 30 days').optional(),
    images: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].array(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().url('Invalid image URL')).min(1, 'At least one image is required').max(10, 'Maximum 10 images allowed'),
    createListingSchema: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        title: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(5, 'Title must be at least 5 characters').max(100, 'Title must be at most 100 characters').transform(sanitizers.normalizeSpaces),
        description: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(20, 'Description must be at least 20 characters').max(2000, 'Description must be at most 2000 characters').transform(sanitizers.normalizeSpaces),
        price: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().positive('Price must be positive').min(0.01, 'Price must be at least $0.01').max(10000, 'Price cannot exceed $10,000'),
        category: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].enum([
            'panties',
            'bras',
            'lingerie',
        ...
        wearDuration: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional(),
        images: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].array(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().url()).min(1, 'At least one image is required'),
        listingType: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].enum([
            'regular',
            'auction'
        ]).default('regular'),
        auctionEndDate: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().datetime().optional(),
        startingBid: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().positive().optional()
    })
};
const messageSchemas = {
    messageContent: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'Message cannot be empty').max(1000, 'Message is too long').transform(sanitizers.normalizeSpaces).refine((val)=>!/<script[^>]*>.*?<\/script>/gi.test(val), 'Message cannot contain scripts'),
    customRequest: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        title: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(5, 'Title must be at least 5 characters').max(100, 'Title must be at most 100 characters').transform(sanitizers.normalizeSpaces),
        description: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(20, 'Description must be at least 20 characters').max(500, 'Description must be at most 500 characters').transform(sanitizers.normalizeSpaces),
        price: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().positive('Price must be positive').min(5, 'Minimum price is $5').max(1000, 'Maximum price is $1,000')
    }),
    tipAmount: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().positive('Tip amount must be positive').min(1, 'Minimum tip is $1').max(500, 'Maximum tip is $500')
};
const financialSchemas = {
    amount: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().regex(/^\d+(\.\d{1,2})?$/, 'Invalid amount format').transform((val)=>parseFloat(val)).refine((val)=>val > 0, 'Amount must be positive').refine((val)=>val <= 10000, 'Amount cannot exceed $10,000'),
    withdrawAmount: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().positive('Amount must be positive').min(10, 'Minimum withdrawal is $20').refine((val)=>Math.round(val * 100) / 100 === val, 'Amount must have at most 2 decimal places'),
    depositAmount: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().positive('Amount must be positive').min(5, 'Minimum deposit is $5').max(5000, 'Maximum deposit is $5,000').refine((val)=>Math.round(val * 100) / 100 === val, 'Amount must have at most 2 decimal places'),
    bankAccount: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        accountHolder: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(2, 'Account holder name is required').max(100, 'Account holder name is too long').transform(sanitizers.normalizeSpaces),
        accountNumber: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(8, 'Account number must be at least 8 characters').max(20, 'Account number is too long').regex(/^\d+$/, 'Account number must contain only digits'),
        routingNumber: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().length(9, 'Routing number must be exactly 9 digits').regex(/^\d{9}$/, 'Invalid routing number format'),
        bankName: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(2, 'Bank name is required').max(100, 'Bank name is too long').transform(sanitizers.normalizeSpaces)
    }),
...
const addressSchemas = {
    shippingAddress: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        fullName: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(2, 'Full name is required').max(100, 'Full name is too long').transform(sanitizers.normalizeSpaces),
        streetAddress: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(5, 'Street address is required').max(200, 'Street address is too long').transform(sanitizers.normalizeSpaces),
        apartment: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().max(50, 'Apartment/Suite is too long').transform(sanitizers.normalizeSpaces).optional(),
        city: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(2, 'City is required').max(100, 'City is too long').transform(sanitizers.normalizeSpaces),
        state: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(2, 'State/Province is required').max(100, 'State/Province is too long').transform(sanitizers.normalizeSpaces),
        zipCode: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(3, 'ZIP/Postal code is required').max(20, 'ZIP/Postal code is too long').regex(/^[A-Z0-9\s-]+$/i, 'Invalid ZIP/Postal code format'),
        country: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(2, 'Country is required').max(100, 'Country is too long').transform(sanitizers.normalizeSpaces),
        phone: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(10, 'Phone number is required').max(20, 'Phone number is too long').regex(PATTERNS.phone, 'Invalid phone number format').optional()
    })
};
const searchSchemas = {
    searchQuery: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().max(100, 'Search query is too long').transform(sanitizers.normalizeSpaces).refine((val)=>!/<[^>]*>/.test(val), 'Search query cannot contain HTML'),
    priceRange: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        min: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().min(0, 'Minimum price cannot be negative').optional(),
        max: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().positive('Maximum price must be positive').optional()
    }).refine((data)=>{
...
const adminSchemas = {
    banUser: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        userId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'User ID is required'),
        reason: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(10, 'Ban reason must be at least 10 characters').max(500, 'Ban reason is too long').transform(sanitizers.normalizeSpaces),
        duration: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].enum([
            '1_day',
            '7_days',
            '30_days',
            'permanent'
    ...
    reportAction: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        ...
        notes: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(10, 'Notes must be at least 10 characters').max(500, 'Notes are too long').transform(sanitizers.normalizeSpaces)
    })
};
const fileSchemas = {
    imageUpload: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    ...
    documentUpload: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        file: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].instanceof(File, {
            message: 'Please select a file'
...
function validateField(schema, fieldName, value) {
    try {
        ...
        if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].ZodError) {
            var _error_errors_;
            return (_error_errors_ = error.errors[0]) === null || _error_errors_ === void 0 ? void 0 : _error_errors_.message;
        }
...
"[project]/src/utils/security/rate-limiter.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class ActionRateLimiter {
   ...
   */ check(action, config) {
        ...
        // Check if blocked
        if ((entry === null || entry === void 0 ? void 0 : entry.blockedUntil) && entry.blockedUntil > now) {
   ...
   */ getKey(action, identifier) {
        return identifier ? "".concat(action, ":").concat(identifier) : action;
    }
    /**
   ...
   */ cleanupExpired() {
    ...
    constructor(){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "limits", new Map());
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "storageKey", 'rate_limits');
...
function useRateLimit(action) {
    let config = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : RATE_LIMITS.API_CALL;
    const limiter = getRateLimiter();
...
function getRateLimitMessage(result) {
    if (result.allowed) {
        if (result.remainingAttempts <= 3) {
            return "You have ".concat(result.remainingAttempts, " attempt").concat(result.remainingAttempts === 1 ? '' : 's', " remaining.");
        }
        return '';
    }
    if (result.waitTime) {
        return "Too many attempts. Please wait ".concat(formatWaitTime(result.waitTime), " before trying again.");
    }
...
"[project]/src/utils/security/validation.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class RateLimiter {
    ...
    constructor(maxAttempts = 5, windowMs = 60000){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "attempts", new Map());
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "maxAttempts", void 0);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "windowMs", void 0);
...
"[project]/src/utils/ordersMigration.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function checkOrdersMigrationNeeded() {
    try {
        ...
        const migrationFlag = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$storage$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storageService"].getItem('orders_migrated_to_service', false);
        if (migrationFlag) {
            return false; // Already migrated
        }
        // Check if old orders exist in storage
        const oldOrders = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$storage$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storageService"].getItem('wallet_orders', []);
...
async function migrateOrdersToService() {
    try {
        ...
        const isAuthenticated = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].isAuthenticated();
        if (!isAuthenticated) {
            console.log('[OrdersMigration] No authenticated user - skipping API migration');
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$storage$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storageService"].setItem('orders_migrated_to_service', true);
            return {
                success: true,
                migratedCount: 0
            };
        ...
        const existingOrders = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$storage$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storageService"].getItem('wallet_orders', []);
        ...
        console.log("[OrdersMigration] Found ".concat(existingOrders.length, " orders to migrate"));
        let migratedCount = 0;
        const errors = [];
        // Process each order
        for (const order of existingOrders){
            try {
                ...
                const existingResult = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$orders$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ordersService"].getOrder(order.id);
                if (existingResult.success && existingResult.data) {
                    console.log("[OrdersMigration] Order ".concat(order.id, " already exists, skipping"));
                    migratedCount++;
                    continue;
                }
                // Create order through service
                const createResult = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$orders$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ordersService"].createOrder({
                    title: order.title,
                ...
                if (createResult.success) {
                    ...
                    if (order.shippingStatus && order.shippingStatus !== 'pending') {
                        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$orders$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ordersService"].updateOrderStatus(order.id, {
                            shippingStatus: order.shippingStatus
                        });
                    }
                } else {
                    var _createResult_error;
                    errors.push("Failed to migrate order ".concat(order.id, ": ").concat((_createResult_error = createResult.error) === null || _createResult_error === void 0 ? void 0 : _createResult_error.message));
                }
            } catch (error) {
                errors.push("Error migrating order ".concat(order.id, ": ").concat(error));
            }
        }
        // Log any errors
        if (errors.length > 0) {
        ...
        // Set migration flag
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$storage$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storageService"].setItem('orders_migrated_to_service', true);
        console.log("[OrdersMigration] Migration complete. Migrated ".concat(migratedCount, "/").concat(existingOrders.length, " orders"));
        return {
...
async function syncOrdersWithService() {
    try {
        ...
        const [storageOrders, serviceResult] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$storage$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storageService"].getItem('wallet_orders', []),
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$orders$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ordersService"].getOrders()
        ]);
        ...
        if (ordersToAdd.length > 0) {
            console.log("[OrdersSync] Found ".concat(ordersToAdd.length, " orders to sync to service"));
            for (const order of ordersToAdd){
                try {
                    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$orders$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ordersService"].createOrder({
                        title: order.title,
                        description: order.description,
                        price: order.price,
                        markedUpPrice: order.markedUpPrice,
                    ...
                    console.error("[OrdersSync] Failed to sync order ".concat(order.id, ":"), error);
                }
            }
        }
    ...
    try {
        ...
        for (const order of orders){
            if (orderIds.has(order.id)) {
                issues.push("Duplicate order ID found: ".concat(order.id));
            }
        ...
        for (const order of orders){
            ...
            if (!order.title) issues.push("Order ".concat(order.id, " missing title"));
            if (!order.seller) issues.push("Order ".concat(order.id, " missing seller"));
            if (!order.buyer) issues.push("Order ".concat(order.id, " missing buyer"));
            if (typeof order.price !== 'number') issues.push("Order ".concat(order.id, " has invalid price"));
            if (!order.date) issues.push("Order ".concat(order.id, " missing date"));
        }
        return {
        ...
        issues.push("Validation error: ".concat(error));
        return {
            valid: false,
            issues
        };
...
"[project]/src/utils/security/permissions.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function isAdmin(user) {
    var _user_role;
    return ((_user_role = user === null || user === void 0 ? void 0 : user.role) !== null && _user_role !== void 0 ? _user_role : null) === 'admin';
}
function hasRole(user, role) {
    var _user_role;
    return ((_user_role = user === null || user === void 0 ? void 0 : user.role) !== null && _user_role !== void 0 ? _user_role : null) === role;
}
function canAccessRole(user, requiredRole) {
    var _user_role;
    const r = (_user_role = user === null || user === void 0 ? void 0 : user.role) !== null && _user_role !== void 0 ? _user_role : null;
...
"[project]/src/types/users.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function calculateProfileCompleteness(user, profile) {
    ...
    if (!(profile === null || profile === void 0 ? void 0 : profile.bio) || profile.bio.length < 50) missingFields.push('Bio (minimum 50 characters)');
    else completedCount++;
    if (!(profile === null || profile === void 0 ? void 0 : profile.subscriptionPrice) || profile.subscriptionPrice === '0') {
    ...
    if (user.role === 'seller') {
        var _profile_galleryImages;
        if (!user.isVerified) missingFields.push('Verification');
        if (!(profile === null || profile === void 0 ? void 0 : (_profile_galleryImages = profile.galleryImages) === null || _profile_galleryImages === void 0 ? void 0 : _profile_galleryImages.length)) missingFields.push('Gallery Images');
    }
...
"[project]/src/types/common.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const Money = {
    ...
    format: (money)=>"$".concat((money / 100).toFixed(2))
};
const USER_ROLES = {
    BUYER: 'buyer',
    SELLER: 'seller',
...
__turbopack_context__.k.register(_c, "UserId");
__turbopack_context__.k.register(_c1, "ListingId");
__turbopack_context__.k.register(_c2, "OrderId");
__turbopack_context__.k.register(_c3, "MessageId");
__turbopack_context__.k.register(_c4, "NotificationId");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/src/types/websocket.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/errorTracking.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class ErrorTracker {
    ...
    captureError(error, context) {
        ...
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_ERROR_TRACKING_ENDPOINT) {
            fetch(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_ERROR_TRACKING_ENDPOINT, {
                method: 'POST',
                headers: {
    ...
    captureMessage(message) {
        ...
        console.log("[ErrorTracker:".concat(level, "]"), message);
    }
    constructor(){
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "handleError", (event)=>{
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "handleRejection", (event)=>{
            var _event_reason;
            this.captureError(new Error(((_event_reason = event.reason) === null || _event_reason === void 0 ? void 0 : _event_reason.message) || 'Unhandled Promise Rejection'), {
...
"[project]/src/hooks/usePerformanceMonitoring.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function usePerformanceMonitoring() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "usePerformanceMonitoring.useEffect": ()=>{
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$web$2d$vitals$2f$dist$2f$web$2d$vitals$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onINP"])(sendToAnalytics); // Note: FID is replaced with INP in newer versions
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "usePerformanceMonitoring.useEffect": ()=>{
            const handleRouteChange = {
                "usePerformanceMonitoring.useEffect.handleRouteChange": ()=>{
            ...
            const handleRouteChangeComplete = {
                "usePerformanceMonitoring.useEffect.handleRouteChangeComplete": ()=>{
...
_s(usePerformanceMonitoring, "tjXKfJWuFDa0epp0CJaCeazyqhM=", false, function() {
    return [
...
function sendToAnalytics(metric) {
    ...
    if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_ANALYTICS_ENDPOINT) {
        fetch("".concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_ANALYTICS_ENDPOINT, "/metrics"), {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$AgeVerificationModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/AgeVerificationModal.tsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$MessageNotifications$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/MessageNotifications.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$PWAInstall$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/PWAInstall.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$GoogleAnalytics$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/GoogleAnalytics.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$errorTracking$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/errorTracking.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$usePerformanceMonitoring$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/usePerformanceMonitoring.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function ClientLayout(param) {
                ...
                window.addEventListener('load', {
                    "ClientLayout.useEffect": ()=>{
                        navigator.serviceWorker.register('/sw.js').then({
                            "ClientLayout.useEffect": (registration)=>console.log('SW registered:', registration)
                        }["ClientLayout.useEffect"]).catch({
                            "ClientLayout.useEffect": (error)=>console.log('SW registration failed:', error)
                        }["ClientLayout.useEffect"]);
                    }
                }["ClientLayout.useEffect"]);
            }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ClientLayout.useEffect": ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$errorTracking$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["errorTracker"].initialize();
        }
    }["ClientLayout.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$usePerformanceMonitoring$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePerformanceMonitoring"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ClientLayout.useEffect": ()=>{
            if ("TURBOPACK compile-time truthy", 1) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$GoogleAnalytics$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GoogleAnalytics"], {}, void 0, false, {
                fileName: "[project]/src/app/ClientLayout.tsx",
                lineNumber: 83,
                columnNumber: 7
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$Providers$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                children: [
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$BanCheck$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$AgeVerificationModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                                        fileName: "[project]/src/app/ClientLayout.tsx",
                                        lineNumber: 93,
                                        columnNumber: 15
                                    }, this),
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$MessageNotifications$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                                        fileName: "[project]/src/app/ClientLayout.tsx",
                                        lineNumber: 95,
                                        columnNumber: 15
                                    }, this)
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$PWAInstall$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PWAInstall"], {}, void 0, false, {
                        fileName: "[project]/src/app/ClientLayout.tsx",
                        lineNumber: 101,
                        columnNumber: 9
                    }, this)
...
_s(ClientLayout, "B/oGGP1bOo68b0RgbO6xHddQ3Zo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$usePerformanceMonitoring$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePerformanceMonitoring"]
    ];
});
_c1 = ClientLayout;
var _c, _c1;
...
//# sourceMappingURL=src_5d64a7bd._.js.map