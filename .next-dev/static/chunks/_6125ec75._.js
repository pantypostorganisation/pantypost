...
"[project]/src/components/admin/bans/ExpiredBansContent.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "default": ()=>ExpiredBansContent
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
...
;
;
const filterAndSortBans = (bans, filters)=>{
    if (!Array.isArray(bans)) return [];
    const sanitizedSearchTerm = filters.searchTerm ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$security$2f$sanitization$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sanitizeSearchQuery"])(filters.searchTerm).toLowerCase() : '';
    const sortOrder = filters.sortOrder === 'asc' || filters.sortOrder === 'desc' ? filters.sortOrder : 'desc';
    const filterBy = [
        'all',
        'temporary',
        'permanent'
    ].includes(filters.filterBy) ? filters.filterBy : 'all';
    const filtered = bans.filter((ban)=>{
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$banUtils$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isValidBan"])(ban)) return false;
        const matchesSearch = sanitizedSearchTerm ? ban.username.toLowerCase().includes(sanitizedSearchTerm) || ban.reason && ban.reason.toLowerCase().includes(sanitizedSearchTerm) || ban.customReason && ban.customReason.toLowerCase().includes(sanitizedSearchTerm) : true;
        const matchesFilter = filterBy === 'all' ? true : filterBy === 'temporary' ? ban.banType === 'temporary' : ban.banType === 'permanent';
...
function ExpiredBansContent(param) {
    let { expiredBans, filters } = param;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                ...
                fileName: "[project]/src/components/admin/bans/ExpiredBansContent.tsx",
                lineNumber: 49,
                columnNumber: 7
            }, this),
            filteredBans.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "No expired bans found"
                    }, void 0, false, {
                        fileName: "[project]/src/components/admin/bans/ExpiredBansContent.tsx",
                        lineNumber: 53,
                        columnNumber: 11
                    }, this),
                    filters.searchTerm && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                ...
                children: filteredBans.map((ban)=>{
                    ...
                    const hours = ban.banType === 'permanent' || !ban.endTime || !ban.startTime ? null : Math.ceil((new Date(ban.endTime).getTime() - new Date(ban.startTime).getTime()) / (1000 * 60 * 60));
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "bg-[#1a1a1a] border border-gray-800 rounded-lg p-6 opacity-75",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "px-2 py-1 bg-gray-900/20 text-gray-400 text-xs rounded font-medium",
                                                children: "Expired/Lifted"
                                            }, void 0, false, {
                                                fileName: "[project]/src/components/admin/bans/ExpiredBansContent.tsx",
                                                lineNumber: 75,
                                                columnNumber: 25
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "text-gray-300 ml-2",
                                                        children: ban.banType === 'permanent' ? 'Permanent' : hours !== null ? "".concat(hours, " hours") : 'Unknown'
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/admin/bans/ExpiredBansContent.tsx",
                                                        lineNumber: 85,
                                                        columnNumber: 27
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "text-gray-300 ml-2",
                                                        children: ban.startTime ? new Date(ban.startTime).toLocaleString() : 'Unknown'
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/admin/bans/ExpiredBansContent.tsx",
                                                        lineNumber: 91,
                                                        columnNumber: 27
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "text-gray-300 ml-2",
                                                        children: ban.endTime ? new Date(ban.endTime).toLocaleString() : 'Manually lifted'
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/admin/bans/ExpiredBansContent.tsx",
                                                        lineNumber: 95,
                                                        columnNumber: 27
...
_c = ExpiredBansContent;
var _c;
__turbopack_context__.k.register(_c, "ExpiredBansContent");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_6125ec75._.js.map