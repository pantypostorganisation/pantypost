...
"[project]/src/components/admin/bans/BanTabs.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
function BanTabs(param) {
    let { activeTab, onTabChange, banStats, expiredCount, historyCount } = param;
    ...
    const tabs = [
        {
            key: 'active',
            label: 'Active Bans',
            count: safeCount(banStats === null || banStats === void 0 ? void 0 : banStats.totalActiveBans),
        ...
        },
        {
            key: 'appeals',
            label: 'Appeals',
            count: safeCount(banStats === null || banStats === void 0 ? void 0 : banStats.pendingAppeals),
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: tabs.map((tab)=>{
            ...
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                ...
                "aria-controls": "panel-".concat(tab.key),
                onClick: ()=>onTabChange(tab.key),
                className: "flex-1 px-4 py-2 rounded-md text-sm font-medium transition-all flex items-center justify-center gap-2 ".concat(isActive ? 'bg-[#ff950e] text-black shadow-lg' : 'text-gray-300 hover:text-white hover:bg-[#333]'),
                children: [
...
_c = BanTabs;
var _c;
__turbopack_context__.k.register(_c, "BanTabs");
...
//# sourceMappingURL=_196f7d91._.js.map