...
"[project]/src/components/admin/bans/AppealReviewModal.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const humanize = (s)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$security$2f$sanitization$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sanitizeStrict"])(s).replace(/_/g, ' ').replace(/\b\w/g, (c)=>c.toUpperCase());
function AppealReviewModal({ ban, appealReviewNotes, setAppealReviewNotes, isLoading, onClose, onConfirm, onShowEvidence }) {
    if (!ban) return null;
    ...
    const handleNotesChange = (value)=>{
        setAppealReviewNotes((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$security$2f$sanitization$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sanitizeStrict"])(value));
    };
    ...
    const safeUsername = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$security$2f$sanitization$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sanitizeStrict"])(ban.username || '');
    const safeBanType = humanize(ban.banType || '');
    const safeBannedBy = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$security$2f$sanitization$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sanitizeStrict"])(ban.bannedBy || '');
...
//# sourceMappingURL=_384a7cf1._.js.map