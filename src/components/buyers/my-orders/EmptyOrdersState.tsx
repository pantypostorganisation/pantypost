...
export default function EmptyOrdersState() {
  return (
    <div className="rounded-lg border border-white/10 bg-black/40 px-8 py-16 text-center">
      <div className="mx-auto flex max-w-2xl flex-col items-center gap-8">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <Link
            href="/browse"
            className="inline-flex items-center gap-2 rounded-lg bg-primary px-8 py-3 text-base font-semibold text-black transition-colors hover:bg-primary-hover"
          >
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-lg border border-white/15 bg-white/5 px-8 py-3 text-base font-semibold text-white transition-colors hover:bg-white/10"
          >
