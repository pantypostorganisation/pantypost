...
export default function OrderStats({ stats }: OrderStatsProps) {
  return (
    <div className="grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-6">
      {/* Total Spent Card */}
      <div className="rounded-lg border border-primary/30 bg-black/30 p-6">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-xs font-medium uppercase tracking-wider text-primary-hover">Total spent</p>
            <p className="mt-2 text-3xl font-bold text-white">${stats.totalSpent.toFixed(2)}</p>
            <p className="mt-1 text-xs text-primary-hover/80">Includes platform fees and credits redeemed</p>
          </div>
          <div className="flex h-14 w-14 items-center justify-center rounded-lg border border-primary/50 bg-primary/15 text-primary">
      ...
      {/* Pending Orders Card */}
      <div className="rounded-lg border border-yellow-400/25 bg-black/30 p-6">
        <div className="flex items-center justify-between">
          <div>
          ...
          <div className="flex h-14 w-14 items-center justify-center rounded-lg border border-yellow-300/50 bg-yellow-300/15 text-yellow-200">
      ...
      {/* Shipped Orders Card */}
      <div className="rounded-lg border border-sky-400/25 bg-black/30 p-6">
        <div className="flex items-center justify-between">
          <div>
          ...
          <div className="flex h-14 w-14 items-center justify-center rounded-lg border border-sky-300/50 bg-sky-300/15 text-sky-200">
