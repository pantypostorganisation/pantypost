  ...
  return (
    <div className="space-y-6">
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        <div className="flex items-start justify-between rounded-lg border border-gray-800 bg-[#0c0c0c] p-4 shadow-sm">
          <div>
          ...
          <div className="ml-3 flex h-10 w-10 items-center justify-center rounded-lg border border-[#ff950e]/30 bg-[#ff950e]/10">
            <img
