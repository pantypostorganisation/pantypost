...
export default function WithdrawConfirmModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
      <div className="w-full max-w-lg rounded-lg border border-gray-800 bg-[#111] p-6 shadow-2xl sm:p-8">
        <div className="flex items-center gap-4">
          <div className="flex h-14 w-14 items-center justify-center rounded-lg border border-amber-400/30 bg-amber-400/10">
        ...
        <div className="mt-6 space-y-4 rounded-lg border border-gray-800 bg-[#0c0c0c] p-5 text-sm text-gray-300">
          <p>
        ...
        <div className="mt-6 flex flex-col gap-3 sm:flex-row">
          <button
            ...
            disabled={isLoading}
            className="flex-1 rounded-lg border border-gray-800 px-4 py-3 text-sm font-semibold text-gray-300 transition-colors hover:bg-[#1b1b1b] disabled:cursor-not-allowed disabled:opacity-60"
          >
            Cancel
          </button>
          <button
            ...
            disabled={isLoading}
            className="flex-1 inline-flex items-center justify-center gap-2 rounded-lg border border-transparent bg-[#ff950e] px-4 py-3 text-sm font-semibold text-black transition-colors hover:bg-primary-hover disabled:cursor-not-allowed disabled:opacity-60"
          >
            {isLoading ? (
              <>
