    ...
    <section className="rounded-lg border border-gray-800 bg-[#111] p-6 transition-colors sm:p-8">
      <div className="flex flex-col gap-6">
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          <div className="flex h-14 w-14 items-center justify-center rounded-lg border border-green-500/30 bg-green-500/10">
        ...
        <div className="flex flex-col gap-3 rounded-lg border border-gray-800 bg-[#0c0c0c] p-4 text-xs text-gray-400 sm:flex-row sm:items-center sm:justify-between sm:text-sm">
