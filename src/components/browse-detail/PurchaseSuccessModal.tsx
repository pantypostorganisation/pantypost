...
// Import icons with better error handling for HMR
import dynamic from 'next/dynamic';

// Dynamically import icons to avoid HMR issues
...
// Simple confetti alternative using CSS animations
...
export default function PurchaseSuccessModal({
  ...
  // Trigger celebration animation for auction winner
  useEffect(() => {
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <motion.h2 
                ...
                className="text-3xl font-bold text-white mb-2 bg-gradient-to-r from-yellow-400 to-yellow-600 bg-clip-text text-transparent"
              >
                🎉 Congratulations! 🎉
              </motion.h2>
              ...
              <motion.p 
                ...
                className="text-xl text-yellow-400 mb-4 font-semibold"
              >
                You Won the Auction!
              </motion.p>
              ...
              <motion.div 
                ...
                className="bg-black/40 backdrop-blur p-4 rounded-2xl space-y-3 mb-6"
              >
                ...
                <div className="border-t border-gray-600 pt-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-2xl font-bold text-gradient bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent">
                      ${listing.auction?.highestBid?.toFixed(2)}
                    </span>
                  </div>
                </div>
              ...
              <div className="space-y-3">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full bg-gradient-to-r from-green-600 to-green-500 text-white px-4 py-3 rounded-xl hover:from-green-500 hover:to-green-400 font-bold transition shadow-lg"
                >
                  View My Orders
                </motion.button>
                ...
                <motion.button
                  ...
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="w-full bg-purple-600/20 border border-purple-600 text-purple-400 px-4 py-3 rounded-xl hover:bg-purple-600/30 font-bold transition"
                >
        ...
        >
          ...
          >
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="w-full bg-gradient-to-r from-[#ff950e] to-[#e88800] text-black px-4 py-3 rounded-xl hover:from-[#e88800] hover:to-[#d77700] font-bold transition shadow-lg"
            >
              Go to My Orders
            </motion.button>
          </motion.div>
