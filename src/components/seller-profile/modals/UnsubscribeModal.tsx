...
export default function UnsubscribeModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-surface/85 backdrop-blur">
      <div className="w-full max-w-md rounded-lg border border-white/10 bg-surface/70 p-8 shadow-[0_25px_70px_-40px_rgba(0,0,0,0.9)]">
        <div className="flex flex-col items-center text-center">
          <div className="inline-flex items-center gap-2 rounded-md border border-red-500/40 bg-red-500/10 px-4 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-red-300">
            Manage Access
          </div>
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
          ...
          <button
            onClick={onConfirm}
            className="w-full rounded-md border border-red-500/40 bg-red-500/20 px-6 py-3 text-sm font-semibold text-red-200 transition hover:border-red-400 hover:bg-red-500/30"
            type="button"
          >
            Unsubscribe
          </button>
