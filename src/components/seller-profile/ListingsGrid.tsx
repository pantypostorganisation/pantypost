...
export default function ListingsGrid({
  ...
  return (
    <div className="mt-12">
      <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-white">Listings by {sanitizedUsername}</h2>
            ...
            return (
              ...
              >
                <div className="relative w-full h-56 overflow-hidden">
                  ...
                  {listing.isPremium && !hasAccess && (
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-center bg-black bg-opacity-70 text-white font-bold rounded-xl p-4">
                      ...
                      <p className="text-sm text-gray-300 mb-4">Subscribe to {sanitizedUsername} to unlock this listing.</p>
                ...
                <div className="p-4 flex flex-col flex-grow">
                  <h3 className="text-lg font-bold text-white mb-2">{sanitizedTitle}</h3>
