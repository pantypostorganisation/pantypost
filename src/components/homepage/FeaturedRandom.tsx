...
export default function FeaturedRandom() {
  ...
  if (!loading && listings.length === 0) {
    return (
      <section 
        ...
        className="min-h-[850px] flex items-center mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 md:py-16 bg-black relative z-30"
      >
  ...
  return (
    <section 
      aria-labelledby="featured-random-title" 
      className="min-h-[850px] flex items-center bg-black mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 md:py-16 relative z-30"
    >
      <div className="w-full">
        {/* Section Header */}
