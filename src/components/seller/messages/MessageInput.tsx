        ...
        <div className="px-4 py-2.5">
          <div className="flex w-full items-center gap-2.5 rounded-lg border border-gray-700 bg-[#222] py-1 pl-2.5 pr-3 focus-within:border-transparent focus-within:ring-1 focus-within:ring-[#ff950e]">
            ...
            <SecureTextarea
              ...
              className="flex-1 self-center bg-transparent py-1 text-white focus:outline-none focus:ring-0 min-h-[32px] max-h-20 resize-none overflow-auto leading-[1.6] flex items-center"
              rows={1}
              maxLength={250}
