...
export const TERMS_SECTIONS: TermsSection[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'heading', title: '1.4. Legal Compliance', text: 'Users are solely responsible for ensuring that their use of the Service complies with all applicable local, state, national, and international laws and regulations, including those regarding the sale of adult content and intimate products.' }
    ]
  },
  {
    id: 'user-accounts',
