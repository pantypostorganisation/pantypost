// src/app/blog/is-it-legal-to-sell-used-panties-in-the-us/page.tsx
//
...
export const metadata: Metadata = {
  title: 'Is It Legal to Sell Used Panties in the US? (2026 Guide)',
  description:
    'Yes - selling used panties is legal in the United States for adults. What US sellers need to know about age rules, taxes, shipping and staying safe in 2026.',
  alternates: {
    canonical: '/blog/is-it-legal-to-sell-used-panties-in-the-us',
    languages: {
...
const articleSchema = {
  ...
  '@type': 'BlogPosting',
  headline: 'Is It Legal to Sell Used Panties in the US? (2026 Guide)',
  description:
    'Yes - selling used panties is legal in the United States for adults. What US sellers need to know about age rules, taxes, shipping and staying safe in 2026.',
  url: `${BASE_URL}/blog/is-it-legal-to-sell-used-panties-in-the-us`,
  mainEntityOfPage: `${BASE_URL}/blog/is-it-legal-to-sell-used-panties-in-the-us`,
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Do I need a business licence to sell used panties in the US?',
      acceptedAnswer: { '@type': 'Answer', text: 'For casual selling of your own items, generally no. If you grow into a regular business you may want an LLC for liability and tax reasons, but there is no licence specific to selling worn underwear.' },
    },
    {
      '@type': 'Question',
      name: 'How old do I have to be to sell?',
      acceptedAnswer: { '@type': 'Answer', text: 'Eighteen, everywhere, no exceptions. This is an adult marketplace category and every legitimate platform verifies seller age and identity before allowing a single listing.' },
    },
    {
      '@type': 'Question',
      name: 'Do I have to pay tax on what I earn?',
      acceptedAnswer: { '@type': 'Answer', text: 'Yes - earnings are taxable income. Report them like any other self-employment income and keep records of your sales.' },
    },
  ],
} as const;
      ...
      <header className="bg-surface-raised py-12 border-b border-white/10">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-white">
            Is It Legal to Sell Used Panties in the US?
          </h1>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <section className="mb-12 bg-surface-raised border border-primary/20 rounded-lg p-8">
          ...
          <p className="text-ink-muted">
            Selling your own worn underwear to another consenting adult is legal in the US.
        ...
        <section className="mb-12">
          ...
          <p className="text-ink-muted mb-4">There is no federal law in the United States that prohibits selling your own worn underwear to another consenting adult. A used garment is an item of clothing, not explicit material, so the laws that govern adult content do not apply to the sale itself.</p>
          <p className="text-ink-muted mb-4">A small number of states have hygiene regulations covering the retail resale of second-hand undergarments. Those rules were written for thrift stores and consignment shops and set sanitisation standards for businesses reselling donated stock. They are aimed at retailers, not at a private adult selling their own items to another adult.</p>
          <p className="text-ink-muted mb-4">What is regulated is everything around the sale: both parties must be adults, income is taxable, and anything you ship must be honestly declared. Follow those three rules and you are operating legally in every state.</p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-ink-muted mb-4">Money you earn from selling is income, and the IRS expects it to be reported - typically as self-employment income if you sell regularly. Keep simple records of what you sell and what you earn from day one; it costs nothing and makes tax time painless. Payment platforms may also report your earnings to the IRS above certain thresholds, so the paper trail exists whether or not you keep your own.</p>
        ...
        <section className="mb-12">
          ...
          <p className="text-ink-muted mb-4">USPS does not prohibit mailing worn clothing - your parcel is simply clothing as far as the postal service is concerned. Use sealed, plain packaging with no branding. For international orders, customs forms must describe contents truthfully; "clothing" is accurate and is all that is required.</p>
          <p className="text-ink-muted mb-4">
        ...
        <section className="mb-12">
          ...
          <div className="bg-surface-raised border border-white/10 rounded-lg p-6">
            <h3 className="text-lg font-semibold text-white mb-2">Do I need a business licence to sell used panties in the US?</h3>
            <p className="text-ink-muted">For casual selling of your own items, generally no. If you grow into a regular business you may want an LLC for liability and tax reasons, but there is no licence specific to selling worn underwear.</p>
          </div>
          <div className="bg-surface-raised border border-white/10 rounded-lg p-6">
            <h3 className="text-lg font-semibold text-white mb-2">How old do I have to be to sell?</h3>
            <p className="text-ink-muted">Eighteen, everywhere, no exceptions. This is an adult marketplace category and every legitimate platform verifies seller age and identity before allowing a single listing.</p>
          </div>
          <div className="bg-surface-raised border border-white/10 rounded-lg p-6">
            <h3 className="text-lg font-semibold text-white mb-2">Do I have to pay tax on what I earn?</h3>
            <p className="text-ink-muted">Yes - earnings are taxable income. Report them like any other self-employment income and keep records of your sales.</p>
          </div>
        </section>
