    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-sans">
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start text-center sm:text-left">
        ...
        <div className="flex gap-4 items-center flex-col sm:flex-row mt-6">
          <a
            className="rounded-full bg-[#ff950e] text-white font-medium text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 transition hover:bg-orange-600 flex items-center justify-center"
            href="/browse"
          >
            🔥 Browse Listings
          </a>
          <a
            className="rounded-full border border-black/10 dark:border-white/20 text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 w-full sm:w-auto md:w-[158px] font-medium transition hover:bg-[#f2f2f2] dark:hover:bg-[#1a1a1a] flex items-center justify-center"
            href="/login"
          >
            Log In
          </a>
